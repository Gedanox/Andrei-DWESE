  ...
  countdownElements.forEach(function (el) {
    ...
    var updateCountdown = setInterval(function () {
      ...
      countdownElement.innerHTML = ""
        .concat(days, " days ")
        .concat("0".concat(hours).toString().slice(-2), ":")
        .concat("0".concat(minutes).toString().slice(-2), ":")
        .concat("0".concat(seconds).toString().slice(-2)); // If the count down is over, write some text
...
var drawSvgInit = function drawSvgInit() {
  var drawSvg = function drawSvg(el) {
    ...
    var controller = Object.assign(
      defaultOptions,
      utils.getData(el, Selector.ZANIM_SVG)
    );
  ...
  var triggerSvg = function triggerSvg() {
    var svgTriggerElement = document.querySelectorAll(
      "[".concat(Selector.DATA_ZANIM_SVG_TRIGGER, "]")
    );
    svgTriggerElement.forEach(function (el) {
      if (
        utils.isElementIntoView(el) &&
        el.hasAttribute(Selector.DATA_ZANIM_SVG_TRIGGER)
      ) {
        drawSvg(el);
...
var fancyNavInit = function fancyNavInit() {
  ...
  var isFancynavbarLeft =
    fancynavbar === null || fancynavbar === void 0
      ? void 0
      : fancynavbar.classList.contains(ClassName.FANCYNAVBAR_LEFT);
  var isFancynavbarTop =
    fancynavbar === null || fancynavbar === void 0
      ? void 0
      : fancynavbar.classList.contains(ClassName.FANCYNAVBAR_TOP);
  /*-----------------------------------------------
  |   RTL compatibility
  -----------------------------------------------*/

  if (
    (utils.isRTL() || isFancynavbarLeft) &&
    !(utils.isRTL() && isFancynavbarLeft)
  ) {
    var fancyNavbarBrandImg = document.querySelector(
      Selector.FANCYNAVBAR_BRAND_IMG
    );
    var fancyNavbarTogglerIcon = document.querySelector(
      Selector.FANCYNAVBAR_TOGGLER_ICON
    );
  ...
  if (isFancynavbarTop) {
    var _fancyNavbarBrandImg = document.querySelector(
      Selector.FANCYNAVBAR_BRAND_IMG
    );

    var _fancyNavbarTogglerIcon = document.querySelector(
      Selector.FANCYNAVBAR_TOGGLER_ICON
    );
  ...
  if (fancynavbar) {
    var fancyNavbarCollapse = document.querySelector(
      Selector.FANCYNAVBAR_COLLAPSE
    );
    var fancyNavbarToggler = document.querySelector(
      Selector.FANCYNAVBAR_TOGGLER
    );
    ...
    var fancyNavItems = document.querySelectorAll(
      ""
        .concat(Selector.FANCYNAV_LINK, ", ")
        .concat(Selector.FANCY_DROPDOWN_MENU)
    ...
    var _fancyNavbarTogglerIcon2 = document.querySelector(
      Selector.FANCYNAVBAR_TOGGLER_ICON
    );

    var fancyNavbarTogglerIconPathTop = _fancyNavbarTogglerIcon2.querySelector(
      Selector.PATH_TOP
    );

    var fancyNavbarTogglerIconPathMiddle =
      _fancyNavbarTogglerIcon2.querySelector(Selector.PATH_MIDDLE);

    var fancyNavbarTogglerIconPathBottom =
      _fancyNavbarTogglerIcon2.querySelector(Selector.PATH_BOTTOM);
    ...
    var animateMenu = function animateMenu() {
      _fancyNavbarTogglerIcon2.classList.contains(ClassName.PLAY)
    ...
    var fancyDropdownMenus = document.querySelectorAll(
    ...
    if (fancyDropdownMenus.length) {
      fancyDropdownMenus.forEach(function (el) {
        ...
        var dpMenuPrevSiblingHeight = "".concat(
          fancyDropdownMenu.previousElementSibling.offsetHeight,
          "px"
        );
        fancyDropdownMenu.closest(Selector.FANCY_DROPDOWN).style.height =
          dpMenuPrevSiblingHeight;
      });
      /*-----------------------------------------------
      ...
      window.resize(function () {
        var fancyDropdownList = document.querySelectorAll(
          Selector.FANCY_DROPDOWN
        );
        fancyDropdownList.forEach(function (el) {
          var fancyDropdown = el;
          var dropdownToggleHeight = el.querySelector(
            Selector.FANCY_DROPDOWN_TOGGLE
          ).offsetHeight;

          if (fancyDropdown.classList.contains(ClassName.SHOW)) {
            var fancyDropdownMenuHeight = fancyDropdown.querySelector(
              Selector.FANCY_DROPDOWN_MENU
            ).offsetHeight;
            fancyDropdown.style.height = "".concat(
              dropdownToggleHeight + fancyDropdownMenuHeight,
              "px"
            );
          } else {
    ...
    fancyNavLinks.forEach(function (fancyNavLink) {
      fancyNavLink.addEventListener(Events.CLICK, function (e) {
        ...
        if (fancyLink.closest(Selector.DATA_ONE_PAGE)) {
          ...
          var targetFancyLink = fancyLink.closest(
            Selector.FANCY_DROPDOWN_TOGGLE
          );
          var targetNavSiblings =
            targetFancyLink === null || targetFancyLink === void 0
              ? void 0
              : targetFancyLink.nextElementSibling;
          var siblingsList =
            targetNavSiblings === null || targetNavSiblings === void 0
              ? void 0
              : targetNavSiblings.querySelectorAll(
                  Selector.FANCY_DROPDOWN_ITEM
                );
          ...
          fancyDropdownMenuTl
            ...
            .delay(0.1);
          var targetFancyLinkParentLi =
            fancyLink === null || fancyLink === void 0
              ? void 0
              : fancyLink.closest(Selector.FANCY_DROPDOWN);
          targetFancyLinkParentLi === null || targetFancyLinkParentLi === void 0
            ? void 0
            : (_targetFancyLinkParen = targetFancyLinkParentLi.classList) ===
                null || _targetFancyLinkParen === void 0
            ? void 0
            : _targetFancyLinkParen.toggle(ClassName.SHOW);

          if (
            fancyLink
              .closest(Selector.FANCY_DROPDOWN)
              .classList.contains(ClassName.SHOW)
          ) {
            targetFancyLinkParentLi.style.height = "".concat(
              targetFancyLink.offsetHeight +
                targetFancyLink.nextElementSibling.offsetHeight,
              "px"
            );
          ...
          if (exclusive) {
            ...
            dropdownElements.forEach(function (item) {
              ...
              if (dropdownElement !== currentDropdownEl) {
                dropdownElement.style.height = "".concat(
                  targetFancyLink.offsetHeight,
                  "px"
                );
    ...
    var prevBgClass = togglerbar.classList.value
      .split(" ")
    ...
    if (onscrollFadeIn) {
      ...
      var fancynavBreakpoint = fancynavbar.classList.value
        .split(" ")
        .filter(function (className) {
      ...
      var ChangeFancyNavBG = function ChangeFancyNavBG() {
        ...
        if (window.innerWidth > utils.breakpoints[fancynavBreakpoint]) {
          ...
          togglerbar.style.backgroundColor = "".concat(
...
var cookieNoticeInit = function cookieNoticeInit() {
  ...
  btnNoticeToggle &&
    btnNoticeToggle.addEventListener(Events.CLICK, function (_ref2) {
          ...
          step: function step(state, circle) {
            ...
            circle.setText(
              "<span class='value'>"
                ...
                .concat(userOptions.subText || "", "</span>")
            );
          },
        };
      };
          ...
          navigation: {
            nextEl:
              swiperNav === null || swiperNav === void 0
                ? void 0
                : swiperNav.querySelector(Selector.SWIPER_BUTTON_NEXT),
            prevEl:
              swiperNav === null || swiperNav === void 0
                ? void 0
                : swiperNav.querySelector(Selector.SWIPER_BUTTON_PREV),
          },
          thumbs: {
            swiper: thumbsInit,
          },
